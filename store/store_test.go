...
var _ = Describe("Tests", Ordered, func() {
	...
	// var _ = Describe("GetRawMempoolCount", func() {
	// 	It("should give raw mempool count", func() {
	// 		db, err := model.NewDB(sqlite.Open("gorm.db"), &gorm.Config{})
	// 		if err != nil {
	// 			panic(err)
	// 		}
	// 		s := store.NewStorage(&chaincfg.RegressionNetParams, db)
	// 		count, err := s.GetRawMempoolCount()
	// 		Expect(err).To(BeNil())
	// 		println(count)
	// 	})
	// })
	// var _ = Describe("verifyChain", func() {
	// 	It("should give true", func() {
	// 		db, err := model.NewDB(sqlite.Open("gorm.db"), &gorm.Config{})
	// 		if err != nil {
	// 			panic(err)
	// 		}
	// 		s := store.NewStorage(&chaincfg.RegressionNetParams, db)
	// 		count, err := s.VerifyChainFunc()
	// 		Expect(err).To(BeNil())
	// 		println(count)
	// 	})
	// })
