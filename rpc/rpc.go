...
func Default(str command.Storage) RPC {
	...
	rpc.AddCommand(command.GetDifficulty())
	rpc.AddCommand(command.GetRawMempool())
	// rpc.AddCommand(command.GetBlockChainInfo())
	rpc.AddCommand(command.VerifyChain())
	rpc.AddCommand(command.GetMempoolInfo())
	rpc.AddCommand(command.GetMempoolEntry())
	rpc.AddCommand(command.GetBlockStats())
	rpc.AddCommand(command.GetChainTips())
	rpc.AddCommand(command.GetBlockChainInfo())
	rpc.AddCommand(command.GetTxOut())
	return rpc
}
